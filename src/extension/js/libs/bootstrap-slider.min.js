      ...
      if (b = function (a, b) {
        ...
        _offset: function (b) {
          var c, d, e = 0,
            f = 0;
          if (b.offsetParent)
            do e += b.offsetLeft, f += b.offsetTop, c = a(b).css("transform"), "none" !== c && (d = c.substr(7, c.length - 8).split(","), e += parseInt(d[4], 10), f += parseInt(d[5], 10)); while (b = b.offsetParent);
          return {
            left: e,
            top: f
          }
